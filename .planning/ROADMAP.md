...
**Plans:**
- [ ] 4.1 — KompendiumPage layout redesign: Refactor existing content into card components with collapsible sections, consistent typography, and a sticky section nav — can run in parallel with 4.2
...
**Plans:**
- [ ] 5.1 — MapPage inspection & improvement plan: Read current MapPage.jsx in full, document what interactivity exists vs. what is missing, define the hotspot data structure
