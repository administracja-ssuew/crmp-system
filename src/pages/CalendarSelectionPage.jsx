      ...
      <div className="relative z-10 max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link to="/kalendarz/samorzad" className="group bg-white border border-slate-200 p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl hover:border-emerald-400 transition-all text-center flex flex-col items-center">
            ...
            <h2 className="text-2xl font-black text-slate-800 mb-2">Samorząd Studentów</h2>
            <p className="text-sm text-slate-500 mb-6">Pełny dostęp do wszystkich zasobów: Sale 9, 16, 28J oraz przestrzenie wspólne.</p>
          ...
          <Link to="/kalendarz/organizacje" className="group bg-white border border-slate-200 p-10 rounded-[2.5rem] shadow-xl hover:shadow-2xl hover:border-blue-400 transition-all text-center flex flex-col items-center">
            ...
            <h2 className="text-2xl font-black text-slate-800 mb-2">Organizacje Studenckie</h2>
            <p className="text-sm text-slate-500 mb-6">Dostęp do rezerwacji Sali 28J (Sala Lustrzana) oraz strefy relaksu.</p>
            <span className="text-blue-600 font-bold uppercase text-xs tracking-widest group-hover:translate-x-2 transition-transform">Otwórz kalendarz 28J →</span>
          </Link>
